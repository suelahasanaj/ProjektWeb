...
<body>
    ...
    $sqlmain= "select * from doctor where doctor_email=?";
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord" >
                        <a href="index.php" class="non-style-link-menu "><div><p class="menu-text">Dashboard-i</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Seancat e Mia</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-patient menu-active menu-icon-patient-active">
                        <a href="patient.php" class="non-style-link-menu  non-style-link-menu-active"><div><p class="menu-text">Pacientët e Mi</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "select * from appointment inner join patient on patient.patient_id=appointment.patient_id inner join schedule on schedule.schedule_id=appointment.schedule_id where schedule.doctor_id=$userid;";
                                $selecttype="My";
                                $current="My patients Only";
                            }
                        }
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search12" class="input-text header-searchbar" placeholder="Kërko emër pacienti ose Email" list="patient">&nbsp;&nbsp;
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"><?php echo $selecttype." Pacientët (".$list11->num_rows.")"; ?></p>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="patient.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Shfaq gjithë pacientët &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Shfaq Detaje.</p><br><br>
                                </td>
                            </tr>
                            <tr>
                                
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">ID Pacienti: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
