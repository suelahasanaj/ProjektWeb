        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr>
                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Kërkoni emrin ose emailin e mjekut" list="doctors">&nbsp;&nbsp;
                        ...
                        <input type="Submit" value="Kerko" class="login-btn btn-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
            ...
            <tr>
                <td colspan="2" style="padding-top:30px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Shto Doktorë Të Rinj</p>
                </td>
                <td colspan="2">
            ...
            if ($_POST) {
                ...
                $sqlmain = "select * from doctor order by doctor_id_id desc";
            }
                        ...
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <a class="non-style-link" href="doctors.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp;Lista e Doktorëve &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                        ...
                                        <a href="?action=edit&id=' . $doctor_id . '&error=0" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-edit"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Edito</font></button></a>
                                        &nbsp;&nbsp;&nbsp;
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id=' . $doctor_id . '&name=' . $name . '" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Fshi</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
                                        }
        ...
        if ($action == 'drop') {
            ...
            <div id="popup1" class="overlay">
                    ...
                    . '</td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="email" name="email" class="input-text" placeholder="Adresa e Email-it" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nic" class="input-text" placeholder="Numri NIC" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="tel" name="Tele" class="input-text" placeholder="Numri telefonit" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Zgjidh specialitetin: </label>
            ...
            ';
                ...
                echo '
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                            <br><br><br><br>
                                <h2>Regjistrimi i ri u shtua me sukses!</h2>
                                <a class="close" href="doctors.php">&times;</a>
                                <div class="content">
                ...
                echo '
                    ...
                    . '</td>
                                    ...
                                    <tr>
                                        ...
                                        ID e Doktorit : ' . $id . ' (Gjeneruar Automatikisht)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Zghidh specialitetin: (Current' . $spcil_name . ')</label>
