        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                ...
                . '</td>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Shto Seancë Të Re.</p><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                <form action="add-session.php" method="POST" class="add-new-form">
                                    <label for="title" class="form-label">Titulli i Seancës: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="title" class="input-text" placeholder="Emri i Seancës" required><br>
                                </td>
                            </tr>
                            <tr>
            ...
            echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="number_of_patients" class="form-label">Numri i Pacientëve/Numri i Konsultëss : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="number_of_patients" class="input-text" min="0"  placeholder="Numri përfundimtar i takimit për këtë seancë varet nga ky numër" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="date" class="form-label">Data e seancës: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="time" class="form-label">Orari: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="time" name="time" class="input-text" placeholder="Ora" required><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="submit" value="Vendoseni këtë Seancë" class="login-btn btn-primary btn" name="shedulesubmit">
                                </td>
